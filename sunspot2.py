...
try:
    ...
    year_range = st.sidebar.slider("연도 범위 선택", year_min, year_max, (year_min, year_max))
    ...
    # 산점도 점 크기 조절
    point_size = st.sidebar.slider("산점도 점 크기", 1, 50, 10)



    # 산점도 투명도 조절
    point_alpha = st.sidebar.slider("산점도 투명도", 0.0, 1.0, 0.5, step=0.05)
